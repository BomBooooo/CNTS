...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        # Decoder
        # if configs.model == 'Combined':
        #     activation=nn.Tanh()
        #     trend_projection = nn.Linear(configs.enc_in, configs.d_out, bias=True)
        if configs.model == 'DetectionSupervised' or configs.model == 'Combined':
